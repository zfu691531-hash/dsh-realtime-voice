				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
						...
						children: [
							...
							"。空闲且输入框为空时，千问识别出的完整语句会自动交给 Harness；Harness 推理或播报期间的新语音才保留在原生输入框，等待发送或清空。声纹为可选的抗干扰软门控：开启后，首句只用于腾讯云录入，之后未通过或服务异常的语音只写入输入框而不自动发送；它不能替代身份认证或高风险操作授权，需要 Harness 凭据 TENCENT_SECRET_ID / TENCENT_SECRET_KEY。Tina 属于 Omni，专用 TTS 不支持；默认改用最接近其风格的 Chelsie。桌面壳当前禁用麦克风，点击话筒会在外部浏览器打开同一会话。"
						]
					})
				] })]
			});
